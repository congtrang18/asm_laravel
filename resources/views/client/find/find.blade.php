                ...
                @foreach ($findpost as $item)
                   <div id={{$item->id}}
                    ...
                    <div class="grid-post-item  bold_gpi  fl-wrap">
                        ...
                        <a class="post-category-marker purp-bg" href=../category/technology/index.html>{{$item->tag->name}} </a>
                        <div class=grid-post-content>
                            <h3><a href=../innovations-that-bring-pleasure-to-all-peoples/index.html>{{$item->tieu_de}}</a></h3>
                        ...
                        <div class=grid-post-footer>
                            <div class=author-link><a href=../author/admin/index.html><img
                                        src={{$item->user->avatar}} width=36 height=36 alt="Jessie Bond"
